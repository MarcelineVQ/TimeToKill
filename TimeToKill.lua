...
-- SuperWoW check (required for extended unit IDs)
if not SetAutoloot then
  StaticPopupDialogs["TTK_NO_SUPERWOW"] = {
    text = "|cffffff00TimeToKill|r|cffff0000 requires SuperWoW to operate.|r",
    button1 = TEXT(OKAY),
    timeout = 0,
    whileDead = 1,
    hideOnEscape = 1,
  ...
  StaticPopup_Show("TTK_NO_SUPERWOW")
  return
end
